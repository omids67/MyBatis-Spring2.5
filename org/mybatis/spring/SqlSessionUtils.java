...
// do nothing
   ...
   *                                              {@code SqlSessionFactory} is not using a {@code
    ...
    if (TransactionSynchronizationManager.isSynchronizationActive()) {
      ...
      if (environment.getTransactionFactory() instanceof SpringManagedTransactionFactory) {
        ...
        if (TransactionSynchronizationManager.getResource(environment.getDataSource()) == null) {
          ...
          throw new TransientDataAccessResourceException(
              "SqlSessionFactory must be using a SpringManagedTransactionFactory in order to use Spring transaction " +
                  "synchronization");
        }
      }
    }
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
            "SqlSession [" + session + "] was not registered for synchronization because synchronization is not " +
                "active");
      }
    }
    return session;
